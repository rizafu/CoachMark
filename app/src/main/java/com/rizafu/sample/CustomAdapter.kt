...
internal class CustomAdapter : RecyclerView.Adapter<CustomAdapter.MainViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MainViewHolder {
        ...
        val binding = DataBindingUtil.inflate<ItemCustomBinding>(LayoutInflater.from(parent.context), R.layout.item_custom, parent, false)
    ...
    internal class MainViewHolder(val binding: ItemCustomBinding) : RecyclerView.ViewHolder(binding.root)
